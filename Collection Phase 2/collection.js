...
function add_hero() {
    var supername = $("#heroname").text();

    document.location.href = "insert.php?name=" + supername;
}
            ...
            rowData += `
				<div class="column">
					<div class="card">
						...
						<div class="card-section">
							<h4 id="heroname">${name}</h4>
							<p>${description}</p>
							
						</div>
						<div>
							<input onclick="add_hero()" type="button" value="Click to add to your collection">
						</div>
					</div>
				</div>
			`;
